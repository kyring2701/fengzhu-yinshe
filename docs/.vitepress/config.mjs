    ...
    root: {
      ...
      themeConfig: {
        ...
        nav: [
          ...
          { text: '枫竹曲谱', link: 'https://sheet.somb.xyz' },
          {
            text: '社团相关',
            items: [
    ...
    en: {
      ...
      themeConfig: {
        ...
        nav: [
          ...
          { text: 'Sheet Music', link: 'https://sheet.somb.xyz' },
          {
            text: 'Community',
            items: [
    ...
    ja: {
      ...
      themeConfig: {
        ...
        nav: [
          ...
          { text: '楽譜', link: 'https://sheet.somb.xyz' },
          {
            text: 'コミュニティ',
            items: [
